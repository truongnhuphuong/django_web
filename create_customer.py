...
Customer.objects.create(name="Antonio Moreno Taqueria", country = "Mexico")
Customer.objects.create(name="Around the Horn", country = "UK")
Customer.objects.create(name="Berglunds snabbkop", country = "Sweden")
Customer.objects.create(name="Blauer See Delikatessen", country = "Germany")
Customer.objects.create(name="Blondel pere et fils", country = "France")
...
Customer.objects.create(name="Comércio", country = "Brazil")
